...
const SRC_CLIENT_SUPPORT_CLIENT_API = require( './Web.ClientSupport.ClientApiFile.js' );
const SRC_CLIENT_SUPPORT_OPEN_API = require( './Web.ClientSupport.OpenApiFile.js' );
const SRC_CLIENT_SUPPORT_VIEW_CORE = require( './Web.ClientSupport.ViewCore.js' );
...
exports.ClientSupport_ViewEngine =
	function ClientSupport_ViewEngine( CTX )
	{
			...
			&& CTX.Transport.Settings.ClientSupport.view_engine )
		{
			...
			CTX.Server.Log.trace( `Web.ClientSupport is using '${engine}' views from folder at [${CTX.Transport.Settings.ClientSupport.view_folder}].` );
		}
	};
...
exports.ClientSupport_GenerateClientApiFile =
	function ClientSupport_GenerateClientApiFile( CTX )
	{
			...
			&& CTX.Transport.Settings.ClientSupport.client_api_file )
		{
			...
			CTX.Server.Log.trace( `Web.ClientSupport generated client file at [${CTX.Transport.Settings.ClientSupport.client_api_file}].` );
		}
	};
...
exports.ClientSupport_GenerateOpenApiFile =
	function ClientSupport_GenerateOpenApiFile( CTX )
	{
			...
			&& CTX.Transport.Settings.ClientSupport.open_api_file )
		{
			...
			CTX.Server.Log.trace( `Web.ClientSupport generated open api file at [${CTX.Transport.Settings.ClientSupport.open_api_file}].` );
		}
	};
...
exports.ClientSupport_MountPublicFolder =
	function ClientSupport_MountPublicFolder( CTX )
	{
			...
			&& CTX.Transport.Settings.ClientSupport.public_folder )
		{
			...
			CTX.Server.Log.trace( `Web.ClientSupport mounted route [${public_url}] for public folder at [${CTX.Transport.Settings.ClientSupport.public_folder}].` );
		}
	};
...
exports.ClientSupport_MountRootRoute =
	function ClientSupport_MountRootRoute( CTX )
	{
		if ( CTX.Transport.Settings.ClientSupport
			...
			&& CTX.Transport.Settings.ClientSupport.home_view )
		{
			let root_url = CTX.Transport.ServerPath();
			// let root_view = CTX.Transport.Settings.ClientSupport.Views.root_view;
			let root_view = CTX.Transport.Settings.ClientSupport.home_view;
