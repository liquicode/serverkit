...
//---------------------------------------------------------------------
describe( `141) Storage - MemoryProvider Tests`,
	function ()
	{


		//---------------------------------------------------------------------
		describe( `MemoryProvider Tests (1000 Objects)`,
			function ()
			{
		...
		//---------------------------------------------------------------------
		describe( `UserStorage on MemoryProvider Tests`,
			function ()
			{
		...
		//---------------------------------------------------------------------
		describe( `UserStorage Sharing on MemoryProvider Tests`,
			function ()
			{
