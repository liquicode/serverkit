...
var SERVER_SETTINGS = {
	Services: {
		TestService: {
			UserStorage: {
				storage_provider: 'NedbProvider',
				NedbProvider: {
					filename: '~server-data/TestService/test-data.nedb',
				},
			},
		}
	}
...
//---------------------------------------------------------------------
describe( `145) Storage - NedbProvider Tests`,
	function ()
	{
		...
		//---------------------------------------------------------------------
		describe( `NedbProvider Tests (10 Objects)`,
			function ()
			{
		...
		//---------------------------------------------------------------------
		describe( `UserStorage on NedbProvider Tests`,
			function ()
			{
		...
		//---------------------------------------------------------------------
		describe( `UserStorage Sharing on NedbProvider Tests`,
			function ()
			{
