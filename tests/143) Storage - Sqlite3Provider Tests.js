		...
		TestService: {
			UserStorage: {
				...
				Sqlite3Provider: {
					...
					table_name: 'TestService',				// Name of the table for this service.
				},
			},
		}
	}
...
//---------------------------------------------------------------------
describe( `143) Storage - Sqlite3Provider Tests`,
	function ()
	{


		//---------------------------------------------------------------------
		describe( `Sqlite3Provider Tests (100 Objects)`,
			function ()
			{
		...
		//---------------------------------------------------------------------
		describe( `UserStorage on Sqlite3Provider Tests`,
			function ()
			{
		...
		//---------------------------------------------------------------------
		describe( `UserStorage Sharing on Sqlite3Provider Tests`,
			function ()
			{
